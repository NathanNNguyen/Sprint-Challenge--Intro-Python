...
print("Ends with e:")
# print([human.name[len(human.name) - 1] for human in humans])
# len(human.name) - 1 only return the number of chars in the name
# use human.name[len(human.name) - 1] to have access to the last letter
...
ages = list(range(28, 32))
print(ages)
f = [(human.name, human.age) for human in humans if human.age in ages]
print(f)
